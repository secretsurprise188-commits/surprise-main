...
function Gallery() {
  const [photos] = useState([
    { id: 1, placeholder: '📷', label: 'Memory 1', rotation: -5 },
    { id: 2, placeholder: '🖼️', label: 'Memory 2', rotation: 3 },
    { id: 3, placeholder: '📸', label: 'Memory 3', rotation: -4 },
    { id: 4, placeholder: '🎨', label: 'Memory 4', rotation: 4 },
    { id: 5, placeholder: '🌅', label: 'Memory 5', rotation: -3 },
    { id: 6, placeholder: '🌄', label: 'Memory 6', rotation: 5 }
  ])
        ...
        {photos.map((photo, index) => (
          ...
          >
            ...
            <div className="relative bg-white p-2 md:p-4 shadow-2xl rounded-sm w-full flex flex-col" style={{ aspectRatio: '4/5' }}>
              ...
              {/* Photo Content */}
              <div className="flex-1 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center rounded-sm min-h-0">
